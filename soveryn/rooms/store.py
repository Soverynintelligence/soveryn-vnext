...
def build_cos_relay_brief(
    *,
    ...
    return (
        ...
        f"ok: {status}\n\n"
        "You are Aetheria — house closer briefing Jon on peer work. "
        "Lead with what was handed off or landed, and the solution — not a mood. "
        "You are not managing him; you are synthesizing so he can "
