...
| **Kernel (2026-08-31)** | GLM-5.3-Flash NVFP4 TP=2 | **GLM-5.3-Flash EXL3 TR3 4bpw TP=2**, `http://10.10.10.2:8001`, alias `glm-5.3-flash`, house ctx **32768** (server max 1M). NVFP4 parked. Eve + public stay on Quadro Qwen `:8091`. Librarian embed on helper Quadro `:8096`. | `curl 10.10.10.2:8001/v1/models` · `~/.soveryn/kernel_brain` = `glm` |
