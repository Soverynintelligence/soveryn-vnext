...
6. **(Phase 2) Generative layer** — cited regs Q&A + paralegal drafting (fill a filing template for a computed obligation), on the swappable brain (cloud now / Spark later). Owner reviews & files. Out of MVP.
