...
- source: https://botdirectory.ai/bots/carousel-publisher/
- imported_at: 2026-08-20T09:40:37
- **scheduled: false** (house rule — never auto-live from import)
...
Candidate for CWG — turns written/published content into carousels and reels. Need to verify it is draft-only (never posts without Jon). Imported for review only, not scheduled.
